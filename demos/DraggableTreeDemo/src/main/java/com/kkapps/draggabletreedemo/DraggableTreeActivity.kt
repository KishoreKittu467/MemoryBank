package com.kkapps.draggabletreedemo

import android.os.Bundle
import android.util.Log
import android.view.View
import androidx.appcompat.app.AppCompatActivity
import com.kkapps.draggabletreeview.DraggableTreeView
import com.kkapps.draggabletreeview.SimpleTreeViewAdapter
import com.kkapps.draggabletreeview.TreeNode
...
class DraggableTreeActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        draggableTreeView.setOnDragItemListener(object : DraggableTreeView.DragItemCallback {
