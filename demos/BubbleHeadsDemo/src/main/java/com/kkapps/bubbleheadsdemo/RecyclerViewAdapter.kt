...
import com.kkapps.bubbleheadsview.OverlapRecyclerViewAdapter
import kotlinx.android.synthetic.main.row_overlap_image.view.*
...
//    private val TAG = RecyclerViewAdapter::class.java.simpleName
    ...
    override fun createItemViewHolder(parent: ViewGroup): CustomViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.row_overlap_image, parent, false)
    ...
    override fun bindItemViewHolder(viewHolder: CustomViewHolder, position: Int) {
        ...
        //----bind data to view
        viewHolder.bind(mCurrentImageModel)
    }
    ...
    inner class CustomViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(mImageModel: OverlapImageModel) {
            ...
            if (isLastVisibleItemItem(adapterPosition)) {
                ...
                val drawable = com.kkapps.bubbleheadsview.TextDrawable.builder()
                        .beginConfig()
