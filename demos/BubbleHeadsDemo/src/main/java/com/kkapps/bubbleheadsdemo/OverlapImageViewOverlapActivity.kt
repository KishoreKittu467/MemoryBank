...
import com.kkapps.bubbleheadsview.OverlapRecyclerViewAnimation
import com.kkapps.bubbleheadsview.OverlapRecyclerViewClickListener
...
class OverlapImageViewOverlapActivity : AppCompatActivity(), OverlapRecyclerViewClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val mSpinnerAdapter = CustomSpinnerAdapter(
            this, R.layout.row_overlap_spinner_item,
    ...
    override fun onNormalItemClicked(adapterPosition: Int) {
        toast(
            this,
            "Normal item clicked >> $adapterPosition"
        )
    }
    ...
    override fun onNumberedItemClick(adapterPosition: Int) {
        toast(
            this,
            "Numbered item clicked >> $adapterPosition"
        )
    }
