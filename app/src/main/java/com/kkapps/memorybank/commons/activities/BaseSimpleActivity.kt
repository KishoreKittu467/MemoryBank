...
import com.kkapps.memorybank.commons.asynctasks.CopyMoveTask
import com.kkapps.memorybank.commons.dialogs.ConfirmationDialog
import com.kkapps.memorybank.commons.dialogs.ExportSettingsDialog
import com.kkapps.memorybank.commons.dialogs.FileConflictDialog
import com.kkapps.memorybank.commons.dialogs.WritePermissionDialog
import com.kkapps.memorybank.commons.extensions.*
import com.kkapps.memorybank.commons.helpers.*
import com.kkapps.memorybank.commons.interfaces.CopyMoveListener
...
abstract class BaseSimpleActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!packageName.startsWith("com.kkapps.memorybank.", true)) {
    ...
    fun handleSAFDialog(path: String, callback: (success: Boolean) -> Unit): Boolean {
        return if (!packageName.startsWith("com.kkapps.memorybank")) {
            callback(true)
            false
    ...
    private fun getExportSettingsFilename(): String {
        ...
        if (defaultFilename.isEmpty()) {
            val appName = baseConfig.appId.removeSuffix(".debug").removeSuffix(".pro").removePrefix("com.kkapps.memorybank.")
