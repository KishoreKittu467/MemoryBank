...
class MyContentProvider {
    companion object {
        private const val AUTHORITY = "com.kkapps.memorybank.commons.provider"
        const val SHARED_THEME_ACTIVATED = "com.kkapps.memorybank.commons.SHARED_THEME_ACTIVATED"
        const val SHARED_THEME_UPDATED = "com.kkapps.memorybank.commons.SHARED_THEME_UPDATED"
