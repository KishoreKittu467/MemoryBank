package com.kkapps.memorybank.commons.helpers

import android.content.Context
import android.database.Cursor
import android.net.Uri
import com.kkapps.memorybank.commons.extensions.getIntValue
import com.kkapps.memorybank.commons.extensions.getStringValue
import com.kkapps.memorybank.commons.models.SimpleContact
...
class MyContactsContentProvider {
    companion object {
        private const val AUTHORITY = "com.kkapps.memorybank.commons.contactsprovider"
        ...
        fun getSimpleContacts(context: Context, cursor: Cursor?): ArrayList<SimpleContact> {
            ...
            if (packageName != "com.kkapps.memorybank.dialer" && packageName != "com.kkapps.memorybank.smsmessenger") {
                return contacts
            }
