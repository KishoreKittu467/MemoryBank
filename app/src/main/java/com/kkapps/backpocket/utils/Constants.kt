package com.kkapps.backpocket.utils
...
object Constants {
    ...
    //EVENT_FIELDS
    const val EVENT_TR = "transaction"
    ...
    //TxMODE_FIELDS
    val TxMODE_CASH = "Cash"
    val TxMODE_SBI_CC = "SBI Credit Card"
    ...
    //FEELING_FIELDS
    private const val FEELING_HPY = "Happy"

    //RELATION_FIELDS
    private const val RELATION_SIS = "Sister"

    val EVENT_FIELDS = mutableSetOf(EVENT_TR, EVENT_TODO, EVENT_NOTES, EVENT_DIARY, EVENT_MOOD, EVENT_OTHER)
    val GROUP_FIELDS = mutableSetOf(GROUP_FMLY, GROUP_FRNDS, GROUP_COLL, GROUP_BANK)
    val TxTYPE_FIELDS = mutableSetOf(TxTYPE_PAID)
    val TxMODE_FIELDS = mutableSetOf(TxMODE_CASH)
