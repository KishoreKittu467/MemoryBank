package com.kkapps.commons.activities
...
import com.kkapps.commons.asynctasks.CopyMoveTask
import com.kkapps.commons.dialogs.ConfirmationDialog
import com.kkapps.commons.dialogs.ExportSettingsDialog
import com.kkapps.commons.dialogs.FileConflictDialog
import com.kkapps.commons.dialogs.WritePermissionDialog
import com.kkapps.commons.extensions.*
import com.kkapps.commons.helpers.*
import com.kkapps.commons.interfaces.CopyMoveListener
import com.kkapps.commons.models.FAQItem
import com.kkapps.commons.models.FileDirItem
import java.io.File
...
abstract class BaseSimpleActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!packageName.startsWith("com.kkapps.", true)) {
            if ((0..50).random() == 10 || baseConfig.appRunCount % 100 == 0) {
                val label = "You are using a fake version of the app. For your own safety download the original one from www.kkapps.com. Thanks"
    ...
    fun handleSAFDialog(path: String, callback: (success: Boolean) -> Unit): Boolean {
        return if (!packageName.startsWith("com.kkapps")) {
            callback(true)
            false
    ...
    private fun getExportSettingsFilename(): String {
        ...
        if (defaultFilename.isEmpty()) {
            val appName = baseConfig.appId.removeSuffix(".debug").removeSuffix(".pro").removePrefix("com.kkapps.")
