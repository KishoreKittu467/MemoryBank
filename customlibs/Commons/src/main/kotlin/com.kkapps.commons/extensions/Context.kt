package com.kkapps.commons.extensions
...
import com.kkapps.commons.helpers.MyContentProvider.Companion.COL_APP_ICON_COLOR
import com.kkapps.commons.helpers.MyContentProvider.Companion.COL_BACKGROUND_COLOR
import com.kkapps.commons.helpers.MyContentProvider.Companion.COL_LAST_UPDATED_TS
import com.kkapps.commons.helpers.MyContentProvider.Companion.COL_NAVIGATION_BAR_COLOR
import com.kkapps.commons.helpers.MyContentProvider.Companion.COL_PRIMARY_COLOR
import com.kkapps.commons.helpers.MyContentProvider.Companion.COL_TEXT_COLOR
import com.kkapps.commons.models.AlarmSound
import com.kkapps.commons.models.BlockedNumber
import com.kkapps.commons.models.SharedTheme
import com.kkapps.commons.views.*
import java.io.File
...
fun Context.getFilePublicUri(file: File, applicationId: String): Uri {
    ...
    // if media content uri is null, get our custom uri like content://com.kkapps.gallery.provider/external_files/emulated/0/DCIM/IMG_20171104_233915.jpg
...
fun Context.isThankYouInstalled() = isPackageInstalled("com.kkapps.thankyou")

fun Context.isAProApp() = packageName.startsWith("com.kkapps.") && packageName.removeSuffix(".debug").endsWith(".pro")
...
fun Context.getCanAppBeUpgraded() = proPackages.contains(baseConfig.appId.removeSuffix(".debug").removePrefix("com.kkapps."))
...
fun Context.getDuration(path: String): Int? {
    ...
    return try {
        val retriever = MediaMetadataRetriever()
        retriever.setDataSource(path)
        val toInt = retriever.extractMetadata(MediaMetadataRetriever.METADATA_KEY_DURATION)?.toInt() ?: 0
        Math.round(toInt / 1000f)
    } catch (ignored: Exception) {
        null
    }
}
...
fun Context.isDefaultDialer(): Boolean {
    return if (!packageName.startsWith("com.kkapps.contacts") && !packageName.startsWith("com.kkapps.dialer")) {
        true
    } else if ((packageName.startsWith("com.kkapps.contacts") || packageName.startsWith("com.kkapps.dialer")) && isQPlus()) {
