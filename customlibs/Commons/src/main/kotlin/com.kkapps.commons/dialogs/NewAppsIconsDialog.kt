...
class NewAppsIconsDialog(val activity: Activity) {
    init {
        val view = activity.layoutInflater.inflate(R.layout.dialog_new_apps_icons, null).apply {
            val dialerUrl = "https://play.google.com/store/apps/details?id=com.kkapps.dialer"
            val smsMessengerUrl = "https://play.google.com/store/apps/details?id=com.kkapps.smsmessenger"
            val voiceRecorderUrl = "https://play.google.com/store/apps/details?id=com.kkapps.voicerecorder"
