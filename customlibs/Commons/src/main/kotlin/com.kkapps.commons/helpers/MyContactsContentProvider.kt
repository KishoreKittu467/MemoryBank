package com.kkapps.commons.helpers
...
import com.kkapps.commons.extensions.getIntValue
import com.kkapps.commons.extensions.getStringValue
import com.kkapps.commons.models.SimpleContact
...
class MyContactsContentProvider {
    companion object {
        private const val AUTHORITY = "com.kkapps.commons.contactsprovider"
        ...
        fun getSimpleContacts(context: Context, cursor: Cursor?): ArrayList<SimpleContact> {
            ...
            if (packageName != "com.kkapps.dialer" && packageName != "com.kkapps.smsmessenger") {
                return contacts
            }
